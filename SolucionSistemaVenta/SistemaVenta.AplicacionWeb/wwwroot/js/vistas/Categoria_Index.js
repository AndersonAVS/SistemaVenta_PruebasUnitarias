        ...
        fetch("/Categoria/Crear", {
            ...
            .then(responseJson => {
                ...
                if (responseJson.estado) {
                    ...
                    swal("Éxito", "La categoria ha sido creada", "success")
                } else {
        ...
        fetch("/Categoria/Editar", {
            ...
            .then(responseJson => {
                ...
                if (responseJson.estado) {
                    ...
                    $("#modalData").modal("hide")
                    swal("+Exito", "La categoria ha sido editada", "success")
                } else {
                    swal("Hubo un problema... ", responseJson.mensaje, "error")
                }
            })
            ...
            if (respuesta) {
                ...
                fetch(`/Categoria/Eliminar?IdCategoria=${data.idCategoria}`, {
                    ...
                    .then(responseJson => {
                        ...
                        if (responseJson.estado) { //si la categoría ha sido eliminada o no

                            tablaData.row(fila).remove().draw()

                            swal("Éxito", "La categoria ha sido eliminada", "success")
                        } else {
