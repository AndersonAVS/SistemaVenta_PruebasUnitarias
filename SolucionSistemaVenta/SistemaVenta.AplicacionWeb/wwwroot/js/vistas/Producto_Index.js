...
$(document).ready(function () {
    //la siguiente lógica carga la lista de categorías dentro del edsplegable de categorias
        ...
        fetch("/Producto/Crear", {
            ...
            .then(responseJson => {
                ...
                if (responseJson.estado) {
                    ...
                    swal("Éxito", "El producto ha sido creado", "success")
                } else {
...
$("#tbdata tbody").on("click", ".btn-eliminar", function () {
    ...
    swal({
        title: "¿Está seguro?",
        text: `Se eliminará el producto "${data.descripcion}"`,
        type: "warning",
                ...
                fetch(`/Producto/Eliminar?IdProducto=${data.idProducto}`, {
                    ...
                    .then(responseJson => {
                        ...
                        if (responseJson.estado) {
                            ...
                            swal("Éxito", "El producto ha sido eliminado", "success")
                        } else {
                            swal("Hubo un error... ", responseJson.mensaje, "error")
                        }
                    })
